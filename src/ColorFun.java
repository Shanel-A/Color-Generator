...
public class ColorFun extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Red", "Blue", "Cyan", "Gray", "Green", "Magenta", "Orange", "Pink", "White", "Yellow" }));
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
      ...
      IFactory colFac = new ColoringFactory();
      IColoring color = colFac.doSomething(jComboBox1.getSelectedIndex());
        
    
       
       jPanel1.setBackground(color.getColor());
       jLabel1.setText(color.colorName());
